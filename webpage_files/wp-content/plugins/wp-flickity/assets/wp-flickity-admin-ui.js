				...
				if(images_ids[0]!=""){
					...
					.done(function(response) {
						...
						for(var index in response){
							h = h + '<div class="carousel-cell"><li img-id="'+response[index].id+'"><span class=" remove-flick-image dashicons dashicons-no"></span><img src="'+response[index].thumbnail[0]+'"></li></div>';
						}
